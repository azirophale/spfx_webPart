...
export class DetailsListDocumentsExample extends React.Component<ListProps, IDetailsListDocumentsExampleState> {
...
function _generateDocuments() {
    const items: IDocument[] = []; {
        let results: any = sp.web.lists.getByTitle("Employee").items().then(dt => {
            dt.map(itm =>
                items.push({
                    Id: itm.Id,
                    Name: itm.Name,
